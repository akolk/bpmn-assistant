...
export default {
  ...
  methods: {
    ...
    async determineIntent() {
      ...
      try {
        const response = await fetch('https://bpm-assistant.cloud.anjokolk.com/determine_intent', {
          method: 'POST',
    ...
    async talk(process, selectedModel, needsToBeFinalComment) {
      try {
        ...
        const response = await fetch('https://bpm-assistant.cloud.anjokolk.com/talk', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(payload),
        });
    ...
    async modify(process, selectedModel) {
      try {
        ...
        const response = await fetch('https://bpm-assistant.cloud.anjokolk.com/modify', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(payload),
        });
